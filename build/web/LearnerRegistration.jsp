...
<script type="text/javascript" src="myscripts/LearnerScript.js"></script>

<form method= "post" action="LearnerServlet">
    <table width="450px" class="table table-striped" >
        <tr>
            <td>Learner Name</td>
            <td><input type="text" name="txtLearnerName" id="txtLearnerName" class="form-control" required></td>
        ...
        <tr>
            <td>Register</td>
            <td><input type="submit" name="btnLearnerRegister" value="Register" class="btn btn-primary" onclick="return validation()"></td>
        </tr>
    </table>
</form>
